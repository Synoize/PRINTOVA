...
const MyProfile = () => {
  const { axios, userData, setUserData, backendUrl, token, getUserProfileData } = useContext(AppContext)
      ...
      <div className="flex justify-start">
        {
          isEdit
            ? <button
              className="px-8 py-2 cursor-pointer bg-[#013e70] hover:bg-[#013e70]/90 text-white border rounded-full transition-all"
              onClick={updateUserProfileData}
            >
              Save Information
            </button>
            : <button
              className="px-8 py-2 cursor-pointer border hover:border-zinc-600 rounded-full transition-all"
